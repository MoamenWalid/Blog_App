...
const SidebarLinks = ({ toggle, reverseToggle }) => {
  return ( 
    <div style={{ clipPath: toggle && "polygon(0 0, 100% 0, 100% 100%, 0 100%)" }} className="side-bar md:hidden z-[3] absolute duration-300 top-0 right-0 w-[75vw] sm:w-[50vw] h-[100vh] bg-white-gray">
